...
class AppLocalizations {
  ...
  String get trackProgress => _text('Track your progress', 'Следите за прогрессом');
  ...
  String get noCamerasAvailable => _text('No cameras available', 'Камеры недоступны');
  ...
  String get dashboardHeroTitle =>
      _text('Your AI coach for cleaner reps', 'Ваш AI-тренер для более чистых повторений');
  ...
  String get latestSession => _text('Latest session', 'Последняя тренировка');
  String get seeFullHistory => _text('See full history', 'Открыть всю историю');
  String get openAnalysis => _text('Open analysis', 'Открыть анализ');
  ...
  String get reachedYourGoal => _text('You reached your goal', 'Вы достигли цели');
  ...
  String get standInFrame =>
      _text('Stand so your whole body stays in frame', 'Встаньте так, чтобы тело полностью было в кадре');
  ...
  String get failedToInitializeCamera =>
      _text('Failed to initialize camera', 'Не удалось инициализировать камеру');
  ...
  String get exitWorkoutTitle => _text('Finish workout?', 'Завершить тренировку?');
  ...
  String get workoutComplete => _text('Workout complete', 'Тренировка завершена');
  String repsGoalValue(int repsCount) =>
      _text('$repsCount reps', '$repsCount повторений');
  String durationGoalValue(int seconds) => _text('$seconds sec', '$seconds сек');
  ...
  String get authBenefitProgress => _text('Weekly progress', 'Недельный прогресс');
  String get authBenefitHistory => _text('Workout history', 'История тренировок');
  ...
  String get passwordRequiredError => _text('Enter your password', 'Введите пароль');
  ...
  String techniqueIssue(String apiValue) {
    switch (apiValue) {
      ...
      case 'left_right_asymmetry':
        return _text('left-right asymmetry', 'асимметрия левой и правой стороны');
      default:
  ...
  String cameraInitializationError(String error) =>
      _text('${failedToInitializeCamera}: $error', '${failedToInitializeCamera}: $error');
