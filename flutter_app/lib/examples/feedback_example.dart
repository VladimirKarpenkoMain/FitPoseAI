  ...
  Future<void> startExercise(String exerciseType) async {
    ...
    switch (exerciseType.toLowerCase()) {
      case 'squat':
        ...
        await _currentCoordinator!.speakCustom("Starting squats", priority: true);
        break;
        
      case 'pushup':
        _currentCounter = PushUpCounter();
        _currentCoordinator = WorkoutFeedbackCoordinator(manager);
        await _currentCoordinator!.speakCustom("Starting push-ups", priority: true);
        break;
        
      case 'jumpingjack':
        _currentCounter = JumpingJackCounter();
        _currentCoordinator = WorkoutFeedbackCoordinator(manager);
        await _currentCoordinator!.speakCustom("Starting jumping jacks", priority: true);
        break;
